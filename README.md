...
|[Прогнозирование возраста по фотографии](https://github.com/IliaShi/Portfolio/tree/main/age_assesment)| Учебный проект. Модель предстказывает возраст покупателей в прикассовой на основе фотографии| pandas, tensorflow, numpy, matplotlib |
